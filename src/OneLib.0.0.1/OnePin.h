/* -*- C++ -*- */
  ...
  template<class PinNr,bool (*_get)(PinNr)>
  class InputPin {
    public:
  ...
  > class IOPin:
    public InputPin<PinNr,_get>,
    public OutputPin<PinNr,_set,_on,_off>,
    public IOPinNoDown<PinNr,_modeOff,_modeOut,_modeIn,_modeInUp>
  {
    public:
